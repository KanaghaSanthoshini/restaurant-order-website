  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us by writing a feedback.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Feedback Form</h4>
              </div>
<div>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">All your feedbacks</p>
          <div class="divider"></div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        ...
        <span class="right"> K&M <a class="grey-text text-lighten-4" href="#"></a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
